  ...
  // Load Cross Sections if Element is Found
	  ...
	  if(C_Switch == true)
	    { 
	      ...
	      ReadCrossSectionFile("Carbon12_np_1_12B.dat",theC12NP_1_B12XS);
	      ReadCrossSectionFile("Carbon12_np_2_12B.dat",theC12NP_2_B12XS);
	      ReadCrossSectionFile("Carbon12_np_3_12B.dat",theC12NP_3_B12XS);
	      ReadCrossSectionFile("Carbon12_nd11B.dat",theC12NDB11XS);
	      ReadCrossSectionFile("Carbon12_nd_1_11B.dat",theC12ND_1_B11XS);
	      ReadCrossSectionFile("Carbon12_nd_2_11B.dat",theC12ND_2_B11XS);
	      ReadCrossSectionFile("Carbon12_nd_3_11B.dat",theC12ND_3_B11XS);
	      ReadCrossSectionFile("Carbon12_nd_4_11B.dat",theC12ND_4_B11XS);
	      ReadCrossSectionFile("Carbon12_nd_5_11B.dat",theC12ND_5_B11XS);
	      ReadCrossSectionFile("Carbon12_nd_6_11B.dat",theC12ND_6_B11XS);
	      ReadCrossSectionFile("Carbon12_nd_7_11B.dat",theC12ND_7_B11XS);
	      ReadCrossSectionFile("Carbon12_nt10B.dat",theC12NTB10XS);
	      ReadCrossSectionFile("Carbon12_nt_1_10B.dat",theC12NT_1_B10XS);
	      ReadCrossSectionFile("Carbon12_nt_2_10B.dat",theC12NT_2_B10XS);
	      ReadCrossSectionFile("Carbon12_nt_3_10B.dat",theC12NT_3_B10XS);
	      ReadCrossSectionFile("Carbon12_nt_4_10B.dat",theC12NT_4_B10XS);
	      ReadCrossSectionFile("Carbon12_nt_5_10B.dat",theC12NT_5_B10XS);
	      ReadCrossSectionFile("Carbon12_nt_6_10B.dat",theC12NT_6_B10XS);
...
G4String menate_R_p::ChooseReaction()
{
  ...
  if(H_Switch == true && C_Switch == false && Fe_Switch==false && Al_Switch==false)
  ...
  else if(C_Switch == true || Fe_Switch == true || Al_Switch==true)
    {
     ...
     G4double ProbSigma[31];
     G4double ProbLimit[31];
     if(H_Switch == false){
       ProbSigma[0] = 0.;
       ProbLimit[0] = 0.;
     }
     if(C_Switch == false){
       ...
       ProbSigma[12]=0; ProbLimit[12]=0;
       ProbSigma[13]=0; ProbLimit[13]=0;
       ProbSigma[14]=0; ProbLimit[14]=0;
       ProbSigma[15]=0; ProbLimit[15]=0;
       ProbSigma[16]=0; ProbLimit[16]=0;
       ProbSigma[17]=0; ProbLimit[17]=0;
       ProbSigma[18]=0; ProbLimit[18]=0;
       ProbSigma[19]=0; ProbLimit[19]=0;
       ProbSigma[20]=0; ProbLimit[20]=0;
       ProbSigma[21]=0; ProbLimit[21]=0;
       ProbSigma[22]=0; ProbLimit[22]=0;
       ProbSigma[23]=0; ProbLimit[23]=0;
       ProbSigma[24]=0; ProbLimit[24]=0;
       ProbSigma[25]=0; ProbLimit[25]=0;
       ProbSigma[26]=0; ProbLimit[26]=0;
       ProbSigma[27]=0; ProbLimit[27]=0;
       ProbSigma[28]=0; ProbLimit[28]=0;
       ProbSigma[29]=0; ProbLimit[29]=0;
     }
     if(Fe_Switch == false){
    ...
    // 12C(n,p1)12B*     - N_C12_P_1_B12
    // 12C(n,p2)12B*     - N_C12_P_2_B12
    // 12C(n,p3)12B*     - N_C12_P_3_B12
    // 12C(n,d)11B     - N_C12_D_B11
    // 12C(n,d1)11B*     - N_C12_D_1_B11
    // 12C(n,d2)11B*     - N_C12_D_2_B11
    // 12C(n,d3)11B*     - N_C12_D_3_B11
    // 12C(n,d4)11B*     - N_C12_D_4_B11
    // 12C(n,d5)11B*     - N_C12_D_5_B11
    // 12C(n,d6)11B*     - N_C12_D_6_B11
    // 12C(n,d7)11B*     - N_C12_D_7_B11
    // 12C(n,t)10B     - N_C12_T_B10
    // 12C(n,t1)10B*     - N_C12_T_1_B10
    // 12C(n,t2)10B*     - N_C12_T_2_B10
    // 12C(n,t3)10B*     - N_C12_T_3_B10
    // 12C(n,t4)10B*     - N_C12_T_4_B10
    // 12C(n,t5)10B*     - N_C12_T_5_B10
    // 12C(n,t6)10B*     - N_C12_T_6_B10
    ...
    // 12C(n,n')3alpha - N_C12_NN3Alpha
	 ...
	 if(RecRandnum >= ProbLimit[11] && RecRandnum < ProbLimit[12] && ProbSigma[12] > 0.)
	   { theReaction = "N_C12_D_B11"; }
	 if(RecRandnum >= ProbLimit[12] && RecRandnum < ProbLimit[13] && ProbSigma[13] > 0.)
	   { theReaction = "N_C12_T_B10"; }
	 if(RecRandnum >= ProbLimit[13] && RecRandnum < ProbLimit[14] && ProbSigma[14] > 0.)
	   { theReaction = "N_C12_P_1_B12"; }
	 if(RecRandnum >= ProbLimit[14] && RecRandnum < ProbLimit[15] && ProbSigma[15] > 0.)
	   { theReaction = "N_C12_P_2_B12"; }
	 if(RecRandnum >= ProbLimit[15] && RecRandnum < ProbLimit[16] && ProbSigma[16] > 0.)
	   { theReaction = "N_C12_P_3_B12"; }
	 if(RecRandnum >= ProbLimit[16] && RecRandnum < ProbLimit[17] && ProbSigma[17] > 0.)
	   { theReaction = "N_C12_D_1_B11"; }
	 if(RecRandnum >= ProbLimit[17] && RecRandnum < ProbLimit[18] && ProbSigma[18] > 0.)
	   { theReaction = "N_C12_D_2_B11"; }
	 if(RecRandnum >= ProbLimit[18] && RecRandnum < ProbLimit[19] && ProbSigma[19] > 0.)
	   { theReaction = "N_C12_D_3_B11"; }
	 if(RecRandnum >= ProbLimit[19] && RecRandnum < ProbLimit[20] && ProbSigma[20] > 0.)
	   { theReaction = "N_C12_D_4_B11"; }
	 if(RecRandnum >= ProbLimit[20] && RecRandnum < ProbLimit[21] && ProbSigma[21] > 0.)
	   { theReaction = "N_C12_D_5_B11"; }
	 if(RecRandnum >= ProbLimit[21] && RecRandnum < ProbLimit[22] && ProbSigma[22] > 0.)
	   { theReaction = "N_C12_D_6_B11"; }
	 if(RecRandnum >= ProbLimit[22] && RecRandnum < ProbLimit[23] && ProbSigma[23] > 0.)
	   { theReaction = "N_C12_D_7_B11"; }
	 if(RecRandnum >= ProbLimit[23] && RecRandnum < ProbLimit[24] && ProbSigma[24] > 0.)
	   { theReaction = "N_C12_T_1_B10"; }
	 if(RecRandnum >= ProbLimit[24] && RecRandnum < ProbLimit[25] && ProbSigma[25] > 0.)
	   { theReaction = "N_C12_T_2_B10"; }
	 if(RecRandnum >= ProbLimit[25] && RecRandnum < ProbLimit[26] && ProbSigma[26] > 0.)
	   { theReaction = "N_C12_T_3_B10"; }
	 if(RecRandnum >= ProbLimit[26] && RecRandnum < ProbLimit[27] && ProbSigma[27] > 0.)
	   { theReaction = "N_C12_T_4_B10"; }
	 if(RecRandnum >= ProbLimit[27] && RecRandnum < ProbLimit[28] && ProbSigma[28] > 0.)
	   { theReaction = "N_C12_T_5_B10"; }
	 if(RecRandnum >= ProbLimit[28] && RecRandnum < ProbLimit[29] && ProbSigma[29] > 0.)
	   { theReaction = "N_C12_T_6_B10"; }
       }
 ...
 if(CalcMeth == "ORIGINAL")
   {
	 ...
	 Sigma = GetCrossSection(theKinEng,theC12NDB11XS);
	 ProbDistPerReaction[12] = Sigma*Num_C;
	 Sigma = GetCrossSection(theKinEng,theC12NTB10XS);
	 ProbDistPerReaction[13] = Sigma*Num_C;
	 Sigma = GetCrossSection(theKinEng,theC12NP_1_B12XS);
	 ProbDistPerReaction[14] = Sigma*Num_C;
	 Sigma = GetCrossSection(theKinEng,theC12NP_2_B12XS);
	 ProbDistPerReaction[15] = Sigma*Num_C;
	 Sigma = GetCrossSection(theKinEng,theC12NP_3_B12XS);
	 ProbDistPerReaction[16] = Sigma*Num_C;
	 Sigma = GetCrossSection(theKinEng,theC12ND_1_B11XS);
	 ProbDistPerReaction[17] = Sigma*Num_C;
	 Sigma = GetCrossSection(theKinEng,theC12ND_2_B11XS);
	 ProbDistPerReaction[18] = Sigma*Num_C;
	 Sigma = GetCrossSection(theKinEng,theC12ND_3_B11XS);
	 ProbDistPerReaction[19] = Sigma*Num_C;
	 Sigma = GetCrossSection(theKinEng,theC12ND_4_B11XS);
	 ProbDistPerReaction[20] = Sigma*Num_C;
	 Sigma = GetCrossSection(theKinEng,theC12ND_5_B11XS);
	 ProbDistPerReaction[21] = Sigma*Num_C;
	 Sigma = GetCrossSection(theKinEng,theC12ND_6_B11XS);
	 ProbDistPerReaction[22] = Sigma*Num_C;
	 Sigma = GetCrossSection(theKinEng,theC12ND_7_B11XS);
	 ProbDistPerReaction[23] = Sigma*Num_C;
	 Sigma = GetCrossSection(theKinEng,theC12NT_1_B10XS);
	 ProbDistPerReaction[24] = Sigma*Num_C;
	 Sigma = GetCrossSection(theKinEng,theC12NT_2_B10XS);
	 ProbDistPerReaction[25] = Sigma*Num_C;
	 Sigma = GetCrossSection(theKinEng,theC12NT_3_B10XS);
	 ProbDistPerReaction[26] = Sigma*Num_C;
	 Sigma = GetCrossSection(theKinEng,theC12NT_4_B10XS);
	 ProbDistPerReaction[27] = Sigma*Num_C;
	 Sigma = GetCrossSection(theKinEng,theC12NT_5_B10XS);
	 ProbDistPerReaction[28] = Sigma*Num_C;
	 Sigma = GetCrossSection(theKinEng,theC12NT_6_B10XS);
	 ProbDistPerReaction[29] = Sigma*Num_C;

	 k_tot = 30;//AW 5/8/2024 it was 8, I increased this to 9 if we use the two lines directly above. 5/31/2024 I changed this to 13
       }
     else
       {
	 // Clears array element
	 ...
	 ProbDistPerReaction[12] = 0.;
	 ProbDistPerReaction[13] = 0.;
	 ProbDistPerReaction[14] = 0.;
	 ProbDistPerReaction[15] = 0.;
	 ProbDistPerReaction[16] = 0.;
	 ProbDistPerReaction[17] = 0.;
	 ProbDistPerReaction[18] = 0.;
	 ProbDistPerReaction[19] = 0.;
	 ProbDistPerReaction[20] = 0.;
	 ProbDistPerReaction[21] = 0.;
	 ProbDistPerReaction[22] = 0.;
	 ProbDistPerReaction[23] = 0.;
	 ProbDistPerReaction[24] = 0.;
	 ProbDistPerReaction[25] = 0.;
	 ProbDistPerReaction[26] = 0.;
	 ProbDistPerReaction[27] = 0.;
	 ProbDistPerReaction[28] = 0.;
       }
 ...
 else if(CalcMeth == "MENATE")
   {
     ...
     ProbDistPerReaction[12] = (GetCrossSection(theKinEng,theC12NDB11XS))/barn;// would need to change the max index of the following for loops to 9
     ProbDistPerReaction[13] = (GetCrossSection(theKinEng,theC12NTB10XS))/barn;// would need to change the max index of the following for loops to 10
     ProbDistPerReaction[14] = (GetCrossSection(theKinEng,theC12NP_1_B12XS))/barn;
     ProbDistPerReaction[15] = (GetCrossSection(theKinEng,theC12NP_2_B12XS))/barn;
     ProbDistPerReaction[16] = (GetCrossSection(theKinEng,theC12NP_3_B12XS))/barn;
     ProbDistPerReaction[17] = (GetCrossSection(theKinEng,theC12ND_1_B11XS))/barn;// would need to change the max index of the following for loops to 9
     ProbDistPerReaction[18] = (GetCrossSection(theKinEng,theC12ND_2_B11XS))/barn;// would need to change the max index of the following for loops to 9
     ProbDistPerReaction[19] = (GetCrossSection(theKinEng,theC12ND_3_B11XS))/barn;// would need to change the max index of the following for loops to 9
     ProbDistPerReaction[20] = (GetCrossSection(theKinEng,theC12ND_4_B11XS))/barn;// would need to change the max index of the following for loops to 9
     ProbDistPerReaction[21] = (GetCrossSection(theKinEng,theC12ND_5_B11XS))/barn;// would need to change the max index of the following for loops to 9
     ProbDistPerReaction[22] = (GetCrossSection(theKinEng,theC12ND_6_B11XS))/barn;// would need to change the max index of the following for loops to 9
     ProbDistPerReaction[23] = (GetCrossSection(theKinEng,theC12ND_7_B11XS))/barn;// would need to change the max index of the following for loops to 9
     ProbDistPerReaction[24] = (GetCrossSection(theKinEng,theC12NT_1_B10XS))/barn;// would need to change the max index of the following for loops to 10
     ProbDistPerReaction[25] = (GetCrossSection(theKinEng,theC12NT_2_B10XS))/barn;// would need to change the max index of the following for loops to 10
     ProbDistPerReaction[26] = (GetCrossSection(theKinEng,theC12NT_3_B10XS))/barn;// would need to change the max index of the following for loops to 10
     ProbDistPerReaction[27] = (GetCrossSection(theKinEng,theC12NT_4_B10XS))/barn;// would need to change the max index of the following for loops to 10
     ProbDistPerReaction[28] = (GetCrossSection(theKinEng,theC12NT_5_B10XS))/barn;// would need to change the max index of the following for loops to 10
     ProbDistPerReaction[29] = (GetCrossSection(theKinEng,theC12NT_6_B10XS))/barn;// would need to change the max index of the following for loops to 10

     // Add up Cross Sections
     ProbTot = 0.;  // Reset Probtot

     for(G4int k=0; k<30; k++)
       {ProbTot += ProbDistPerReaction[k];}
 ...
 else if(CalcMeth == "carbon_el_only" && C_Switch == true)
   {
	 ...
	 for(G4int i=0;i<9;i++)
	   { ProbDistPerReaction[i] = 0.; }
	//need to update this for n,d and n,t channels if you want to only look at carbon elastic
	 Sigma = GetCrossSection(theKinEng,theCarbonXS);
	 ProbDistPerReaction[1] = Sigma*Num_C;
...
if(ReactionName == "N_P_elastic")
  {
    //std::cout<<"NP SCATTERING !!!!!!!!! "<<std::endl;
 ...
 else if(ReactionName == "N_C12_P_1_B12")
   {
     // Charge exchange Reaction copied from MENATE
     G4double Q_value = -13.5401*MeV;
 ...
 else if(ReactionName == "N_C12_P_2_B12")
   {
     // Charge exchange Reaction copied from MENATE
     G4double Q_value = -14.2608*MeV;
 ...
 else if(ReactionName == "N_C12_P_3_B12")
   {
     // Charge exchange Reaction copied from MENATE
     G4double Q_value = -15.2079*MeV;
 ...
 else if(ReactionName == "N_C12_D_B11")
   {
     // n,d reaction copied and modified from n,p reaction A.W 05/2024
     G4double Q_value = -13.732*MeV;

     G4ThreeVector MomDir_D;
     G4ThreeVector MomDir_B11;

     G4double Available_Eng = 0.8461538*KinEng_Int+Q_value;
     ...
     //1/169. = Md*Mn/(Mn+MC12)^2
     // .9230769 = MB11/(Mn+MC12)
     // .1478106 = 2*sqrt(Mn*MB11*Md/(Mc12+Mn)^3)

     G4double T_D = 2.0*KinEng_Int/169. + 0.8461538*Available_Eng + 
                    (0.2001365033*sqrt(KinEng_Int*Available_Eng))*cos_theta_iso;
     ...
     if(T_D > 1.e-5)
       {
	 // 1/13. = sqrt(Md*Mn)/(Mn+Mc)
	 // 0.9607689 = sqrt(MB11/(Mn+MC12))

	 G4double Arg = (0.3922322*sqrt(KinEng_Int) + 0.919866211*sqrt(Available_Eng)*cos_theta_iso)/(sqrt(T_D)); 
	 if( Arg > 1.)
	   { Arg = 1.; }
	 theta_D = acos(Arg);
	 phi_D = 2.*Pi*G4UniformRand();
       }

     MomDir_D = GenMomDir(MomDir_Int,theta_D,phi_D);

 // B11 - Need to check kinematics - maybe not right - 18 Apr 2008, BTR

     G4double T_B11 = KinEng_Int + Q_value - T_D;
     G4double theta_B11 = Pi - theta_D;
     G4double phi_B11 = Pi + phi_D;

     MomDir_B11 = GenMomDir(MomDir_Int,theta_B11,phi_B11);

     // Generate a Secondary Deuteron
     G4DynamicParticle* theSecDeuteron = new G4DynamicParticle;
     G4ParticleDefinition* theSecDDefinition = G4Deuteron::Deuteron();
     theSecDeuteron->SetDefinition(theSecDDefinition);
     theSecDeuteron->SetKineticEnergy(T_D);
     theSecDeuteron->SetMomentumDirection(MomDir_D);
    ...
    // Kill the Parent Neutron -----------------------
     ...
     // Set final tracks in motion!
     G4Track* theDTrack = new G4Track(theSecDeuteron,GlobalTime,thePosition);
     theDTrack->SetTouchableHandle(theTouchable);
     G4Track* theB11Track = new G4Track(theSecB11,GlobalTime,thePosition);
     theB11Track->SetTouchableHandle(theTouchable);

     aParticleChange.SetNumberOfSecondaries(2);
     aParticleChange.AddSecondary(theDTrack);
     aParticleChange.AddSecondary(theB11Track);
  
     G4cout << "Made it to the end ! " << G4endl;
   }
 else if(ReactionName == "N_C12_D_1_B11")
   {
     // n,d reaction copied and modified from n,p reaction A.W 05/2024
     G4double Q_value = -15.8568*MeV;
 ...
 else if(ReactionName == "N_C12_D_2_B11")
   {
     // n,d reaction copied and modified from n,p reaction A.W 05/2024
     G4double Q_value = -18.1771*MeV;
 ...
 else if(ReactionName == "N_C12_D_3_B11")
   {
     // n,d reaction copied and modified from n,p reaction A.W 05/2024
     G4double Q_value = -18.75*MeV;
 ...
 else if(ReactionName == "N_C12_D_4_B11")
   {
     // n,d reaction copied and modified from n,p reaction A.W 05/2024
     G4double Q_value = -20.47*MeV;
 ...
 else if(ReactionName == "N_C12_D_5_B11")
   {
     // n,d reaction copied and modified from n,p reaction A.W 05/2024
     G4double Q_value = -21.02*MeV;
 ...
 else if(ReactionName == "N_C12_D_6_B11")
   {
     // n,d reaction copied and modified from n,p reaction A.W 05/2024
     G4double Q_value = -21.71*MeV;
 ...
 else if(ReactionName == "N_C12_D_7_B11")
   {
     // n,d reaction copied and modified from n,p reaction A.W 05/2024
     G4double Q_value = -22.29*MeV;
 ...
 else if(ReactionName == "N_C12_T_B10")
   {
     // n,t reaction copied and modified from n,d reaction A.W 06/2024
     G4double Q_value = -18.929*MeV;

     G4ThreeVector MomDir_T;
     G4ThreeVector MomDir_B10;

     G4double Available_Eng = 0.76923*KinEng_Int+Q_value;
     ...
     G4double T_T = 3.0*KinEng_Int/169. + 0.76923*Available_Eng + 
                    (0.233709*sqrt(KinEng_Int*Available_Eng))*cos_theta_iso;
	 ...
	 G4double Arg = (0.480384*sqrt(KinEng_Int) + 0.877058*sqrt(Available_Eng)*cos_theta_iso)/(sqrt(T_T)); 
	 if( Arg > 1.)
	   { Arg = 1.; }
	 theta_T = acos(Arg);
	 phi_T = 2.*Pi*G4UniformRand();
       }

     MomDir_T = GenMomDir(MomDir_Int,theta_T,phi_T);

 // B11 - Need to check kinematics - maybe not right - 18 Apr 2008, BTR

     G4double T_B10 = KinEng_Int + Q_value - T_T;
     G4double theta_B10 = Pi - theta_T;
     G4double phi_B10 = Pi + phi_T;

     MomDir_B10 = GenMomDir(MomDir_Int,theta_B10,phi_B10);

     // Generate a Secondary Deuteron
     G4DynamicParticle* theSecTriton = new G4DynamicParticle;
     G4ParticleDefinition* theSecTDefinition = G4Triton::Triton();
     theSecTriton->SetDefinition(theSecTDefinition);
     theSecTriton->SetKineticEnergy(T_T);
     theSecTriton->SetMomentumDirection(MomDir_T);

     // Generate a Secondary B10
     G4DynamicParticle* theSecB10 = new G4DynamicParticle;
     // GetIon() Method works whether particle exists in physicslist or not. 
     // Arguements are GetIon(Charge,Mass,ExcitationEng)
     G4ParticleDefinition* theSecB10Definition = G4IonTable::GetIonTable()->GetIon(5,10,0.);
     theSecB10->SetDefinition(theSecB10Definition);
     theSecB10->SetKineticEnergy(T_B10);
     theSecB10->SetMomentumDirection(MomDir_B10);
    ...
    // Kill the Parent Neutron -----------------------
     ...
     // Set final tracks in motion!
     G4Track* theTTrack = new G4Track(theSecTriton,GlobalTime,thePosition);
     theTTrack->SetTouchableHandle(theTouchable);
     G4Track* theB10Track = new G4Track(theSecB10,GlobalTime,thePosition);
     theB10Track->SetTouchableHandle(theTouchable);

     aParticleChange.SetNumberOfSecondaries(2);
     aParticleChange.AddSecondary(theTTrack);
     aParticleChange.AddSecondary(theB10Track);
  
     G4cout << "Made it to the end ! " << G4endl;
   }
 else if(ReactionName == "N_C12_T_1_B10")
   {
     // n,t reaction copied and modified from n,d reaction A.W 06/2024
     G4double Q_value = -19.6475*MeV;
 ...
 else if(ReactionName == "N_C12_T_2_B10")
   {
     // n,t reaction copied and modified from n,d reaction A.W 06/2024
     G4double Q_value = -20.6692*MeV;
 ...
 else if(ReactionName == "N_C12_T_3_B10")
   {
     // n,t reaction copied and modified from n,d reaction A.W 06/2024
     G4double Q_value = -21.0834*MeV;
 ...
 else if(ReactionName == "N_C12_T_4_B10")
   {
     // n,t reaction copied and modified from n,d reaction A.W 06/2024
     G4double Q_value = -22.5162*MeV;
 ...
 else if(ReactionName == "N_C12_T_5_B10")
   {
     // n,t reaction copied and modified from n,d reaction A.W 06/2024
     G4double Q_value = -23.703*MeV;
 ...
 else if(ReactionName == "N_C12_T_6_B10")
   {
     // n,t reaction copied and modified from n,d reaction A.W 06/2024
     G4double Q_value = -24.0394*MeV;
